...
///
#define HALF_EXP_FROM_FIGHT_AGAINST_AI
///
#define DOMAIN_AIR_PURCHASE_RESTRICTION 1
///
#define NO_RAND_DAMAGE
///
#define UNIT_OUTER_RINGS_RANGE_ATTACK_MOD
///
#define UNIT_INNER_RING_RANGE_ATTACK_MOD
///
#define UNIT_NUM_SPECIFIC_FRIENDLY_UNITS_ADJACENT
///
#ifdef UNIT_NUM_SPECIFIC_FRIENDLY_UNITS_ADJACENT
#define UNIT_SAME_TYPE_ADJACENT_MOD
#endif
///
#define UNIT_FIGHT_WELL_DAMAGE
///
#define UNIT_LEVEL_EXPIRIENCE_MODIFIER
///
#define UNIT_HEALTHY_MOD
///
#define UNIT_NO_ADJACENT_MOD
///
#define PROMOTION_ADVANCED_UNIT_COMBAT_MODS
///
#define UNIT_RANGE_ATTACK_AREA_DAMAGE_MOD
///
#define INSTA_HEAL_EVERYPROMOTION
///
#define UNIT_LOW_HEALTH_DEFENSE_MOD
///
#define UNIT_FORTIFICATION_MODIFIER
///
...
///
#define POLICY_SPECIALIST_EXTRA_YIELDS_BY_SPECIALIST_TYPE
///
#define POLICY_SPY_DETECTION
///
#define FREE_POLICY_EVERY_SECOND_BRANCH_FINISHED
///
#define POLICY_FREE_PROMOTION_UNIT_COMBAT
///
#define POLICY_COST_DISCOUNT_THRESHOLD 6
#define POLICY_COST_DISCOUNT_VALUE -15
///
#define LUA_METHOD_GET_MINOR_QUEST_FRIENDSHIP_MOD
...
///
#define UNITY_OF_PROPHETS_EXTRA_PROPHETS 9
///
...
///
#define BELIEF_EXTRA_CITY_TERRITORY_PER_FIRST_CONVERSATION
///
#define BELIEF_BUILDING_CLASS_YIELD_MODIFIERS
///
#define NO_RANDOM_PROPHET
///
#define ENHANCED_WONDER_PRODUCTION_MODIFIER
///
#define BELIEF_FREE_PROMOTION_UNIT_CLASSES
...
///
#define TRAIT_INTERNATIONAL_TRADE_ROUTE_YIELD_CHANGES
///
#define TRAIT_FREE_UNIT_IN_CAPITAL_FOUNDATION
///
#define TRAIT_FREE_BUILDINGS_AFTER_ERA
///
#define NUM_ERA_TYPES 8
///
...
///
#define CHANGE_FOOD_PROD_MINORS_SCALE
///
#define EFFECTIVE_FRIENDSHIP_EQUALS_BASEFRIENDSHIP
///
#define MINOR_FRIENDHSIP_T100
///
...
///
#define LUA_CITY_METHOD_GET_TRADE_VALUES_AT_CITY_TIMES_100
///
...
///
#define BUILDING_ATTRITION_INSIDE_BORDERS
...
///
#define FIX_UPDATE_DEFERRED_FOG_ON_SET_ALLY
///
#define FIX_RESOURCE_LINKED_CITY_ON_SET_HAS_TECH
///
#define FIX_CHANGEADJACENTSIGHT_RECON_INTERRACTION
///
// #define FIX_NOT_REVEALED_WORKING_CITY_TILE_YIELD_DISPLAY
///
// #define FIX_CALCAULATE_NATURE_YIELD_RESEARCHED_RESOURCE_YIELD_DISPLAY
///
...
///
#define FIX_CITY_ESPIONAGE_UPDATE_SPIES
///
#define FIX_FORTIFY_MODIFIER
///
// #define FIX_TEST_PROMOTION_READY
///
#define FIX_DEFENSE_MODIFIER
///
#define FIX_NULL_POINTER_ON_NUKING
///
#define FIX_LUA_METHOD_GET_RANGE_COMBAT_DAMAGE_FOR_AIR_DOMAIN
///
#define FIX_WOUNDED_DAMAGE_MULTIPLIER_FOR_DOMAIN_AIR
///
#define FIX_CHANGE_GOLDEN_AGE_MOVES_ON_START_END_GOLDEN_AGE
///
#define FIX_PROMOTION_MOVES_CHANGE_ON_ADD_PRODUCTION_EXPERIENCE
///
#define FIX_PROMOTION_MOVES_CHANGE_ON_MID_TURN_PROMOTION
///
...
///
#define LESS_VOTES_FOR_VICTORY_FOR_BOUGHT_OUT_MINORS
/*LEAGUE CHANGES END*/
...
// 1008: v12.0  (adds BUILDING_CAPITAL_GOLD_MODIFIER, BELIEF_BUILDING_CLASS_YIELD_MODIFIERS, CITY_MINOR_MAJORITY_OWNER, PLAYER_CULTURE_TIMES_100)
// 1009: v12.1  (adds m_eSettlementFounder for EG_REPLAYDATASET_CONQUEREDCITIES)
# define BUMP_SAVE_VERSION_CITY 1009
// 1000: v7.0   (initial)
...
// 1017: v12.1  (adds fifth bunch of ENHANCED_GRAPHS, BELIEF_FREE_PROMOTION_UNIT_CLASSES)
// 1017: v12.1b (adds EG_REPLAYDATASET_NUMFAITHONBUILDINGS)
...
// 1000: v12.0  (initial)
# define BUMP_SAVE_VERSION_MINOR_CIV_QUEST 1000
// 1000: v12.0  (initial)
# define BUMP_SAVE_VERSION_CITY_ESPIONAGE 1000
#endif
///
...
#define EG_REPLAYDATASET_NUMFAITHONBUILDINGS
...
// science gained from cultural influence
#define EG_REPLAYDATASET_SCIENCEFROMCULTURALINFLUENCE
